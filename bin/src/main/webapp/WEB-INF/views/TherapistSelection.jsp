...
<div class= "wrapper">
 ...
 <a href="/ust/user/Lessons">
 <i class=" fa fa-arrow-left fa-3x">&nbsp;&nbsp;&nbsp;</i></a>
 <a href="/ust/TherapistSound"><i
 ...
 border-bottom: 3px solid #333; width: 80%; margin-left:10%; margin-top:3%; margin-right:10%; ">
             ...
             <h1 style="font-size:35px;"><center><b>Selection</b></center></h1><br>

<a href="../ust/TherapistSound"><button  class="btn btn-primary" style=" margin-left:40%; width:20%; height:10%; 
